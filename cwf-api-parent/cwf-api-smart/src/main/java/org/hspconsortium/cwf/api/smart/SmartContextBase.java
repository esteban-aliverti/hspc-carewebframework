 ...
 * Subclasses must implement the updateContext method (see SmartContextRecord subclass as an
 * example) and should be configured as singleton beans in the desktop application context via
 * Spring IOC. Naming of the singleton beans must follow the convention
 * "smart.context.[context scope]" where [context scope] is the name of the SMART context as passed
 * to the constructor (e.g., "smart.context.user").
 */
