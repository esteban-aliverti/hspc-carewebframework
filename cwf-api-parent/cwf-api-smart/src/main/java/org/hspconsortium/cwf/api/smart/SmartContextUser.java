 ...
 * <p>
 * {@code
 *  <bean id="smart.context.user" parent="smart.context.base" class="org.carewebframework.smart.SmartContextUser"
...
public class SmartContextUser extends SmartContextBase {
    ...
    protected void updateContext(ContextMap context) {
        ...
        if (user != null) {
            ...
            context.put("id", user.getLogicalId());
            context.put("param", "userId");
        }
    }
