...
public class Bootstrapper {
     ...
     * Medication index
     */
    private final Map<String, CodeableConcept> medicationList = new HashMap<String, CodeableConcept>();
    
    private final Map<String, CodeableConcept> conditionList = new HashMap<String, CodeableConcept>();
